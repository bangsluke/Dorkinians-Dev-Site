...
function init() {
  ...
  let e = new Date(),
    t = nextDay(e, 6);
  (t = new Date(t).toLocaleDateString("en-uk", {
    weekday: "short",
    year: "numeric",
    month: "short",
    day: "numeric",
    ...
    Papa.parse(captainsAndAwardsSheetURLCSV, {
      ...
      header: !0,
      fastmode: !0,
      complete: getHomepageTabCaptainsAndAwardsInfo,
    });
  const o = {
  ...
  for (var n in (console.log("hello"), o))
    for (var a in o[n]) console.log(o.TrophyName + o[n][a]);
  console.log(
    ...
    Papa.parse(totalClubStatsSheetURLCSV, {
      ...
      header: !0,
      fastmode: !0,
      complete: getTotalClubStatsInfo,
    }),
    displayInformation(
    ...
    Papa.parse(displayThisSeasonStatsSheetCSV, {
      ...
      header: !0,
      fastmode: !0,
      complete: getPlayerStatsThisSeasonTabInfo,
    }),
    Papa.parse(displayAllTimeStatsSheetCSV, {
      download: !0,
      header: !0,
      fastmode: !0,
      complete: getPlayerStatsAllTimeTabInfo,
    }),
    displayInformation(
...
function updateLoadingPage() {
  let e = setInterval(function () {
    (document.getElementById(
      ...
      setTimeout(function () {
        let e = phrasesArray.length;
        0 === e &&
          (console.alert("loopPhrases timed out."),
          alert("Page timed out. Please refresh."));
        let t = Math.floor(randomNumber(0, e)),
          o = phrasesArray[t];
        delete phrasesArray[t],
          (phrasesArray = phrasesArray.filter(function () {
            return !0;
          })),
          (document.getElementById("loading-phrase").innerHTML = o),
          (document.getElementById(
            "loading-page-loading-phrase-container"
          ).style.opacity = 1);
      }, 1e3),
      (readyComponentsCount === numberReadyComponents ||
        readyComponentsCount >= numberReadyComponents) &&
        (hideLoadingPage(), clearInterval(e));
  }, 6e3);
}
function incrementComponentReadyCount(e) {
  (readyComponentsCount += 1),
...
function hideLoadingPage() {
  ...
  let e = document.getElementById("loading-page");
...
function openNav() {
  (document
    ...
    .shadowRoot.getElementById("side-menu").style.width = sideMenuWidth),
    (document
      .getElementsByTagName("side-menu-component")[0]
      .shadowRoot.getElementById("side-menu").style.right = "0rem"),
    (document.getElementById("background-overlay-side-menu").style.display =
      "inline"),
    (document.getElementById("background-overlay-side-menu").style.zIndex = 19);
  var e = document.getElementsByTagName("header-component")[0];
  e &&
    (document
      .getElementsByTagName("header-component")[0]
      .shadowRoot.getElementById("options-button").style.display = "none");
}
function closeNav() {
  (document
    .getElementsByTagName("side-menu-component")[0]
    .shadowRoot.getElementById("side-menu").style.width = "0"),
    (document
      .getElementsByTagName("side-menu-component")[0]
      .shadowRoot.getElementById("side-menu").style.right = "-0.1rem"),
    (document.getElementById("background-overlay-side-menu").style.display =
      "none");
  var e = document.getElementsByTagName("header-component")[0];
  e &&
    (document
      .getElementsByTagName("header-component")[0]
      .shadowRoot.getElementById("options-button").style.display = "inline");
}
function changeSiteTheme() {
  ...
  "Change to Dark Theme" == e.innerHTML
    ? (document.documentElement.style.setProperty(
      ...
      (e.innerHTML = "Change to Light Theme"),
    ...
    : (document.documentElement.style.setProperty(
      ...
      (e.innerHTML = "Change to Dark Theme"),
      createWeatherWidgetHTML("#F9ED32", "#FFFFFF", "#1C8841"),
      buildWeatherWidget()),
    closeNav();
}
function changeTextSize(e) {
  console.log("changeTextSize clicked. Font size changed by " + e + ".");
  let t = getComputedStyle(document.documentElement).getPropertyValue(
    "--main-font-size"
  );
  (t = parseInt(t.replace("px", ""))),
    console.log("fontSize before is = " + t),
    1 == e ? t < fontSizeMax && (t += e) : t > fontSizeMin && (t += e),
    console.log("fontSize after is = " + t),
    (t += "px"),
    document.documentElement.style.setProperty("--main-font-size", t),
...
function resetActionVariables() {
  document.documentElement.style.setProperty("--main-font-size", "16px"),
    ...
    openPopUpBox("Page Settings Reset", "Font size and theme reset.");
}
function getSideMenuInfo(e) {
  console.log(
    "%c>> getSideMenuInfo.",
    "background-color: yellow; color:black; padding: 0.5em 0em; font-weight: bold;"
  ),
    (displaySiteDetailsArrayOfObjects = e.data),
    showSideMenuInfo(displaySiteDetailsArrayOfObjects);
}
function showSideMenuInfo(e) {
  console.log(
    "%c>> showSideMenuInfo.",
    "background-color: yellow; color:black; padding: 0.5em 0em; font-weight: bold;"
  );
  ...
  (document
    ...
    ).innerHTML = displaySiteDetailsArrayOfObjects[0]["Version Number"]),
    (document
      .getElementsByTagName("side-menu-component")[0]
      .shadowRoot.getElementById(
        "side-menu-site-details-current-season-text"
      ).innerHTML = displaySiteDetailsArrayOfObjects[0]["Current Season"]),
    (document
      .getElementsByTagName("side-menu-component")[0]
      .shadowRoot.getElementById(
        "side-menu-site-details-last-updated-stats-text"
      ).innerHTML = displaySiteDetailsArrayOfObjects[0]["Last Updated Stats"]),
    (document
      .getElementsByTagName("side-menu-component")[0]
      .shadowRoot.getElementById(
        "side-menu-site-details-page-details-last-refereshed-text"
      ).innerHTML =
      displaySiteDetailsArrayOfObjects[0]["Page Details Last Refreshed"]),
...
function getPlayerDropdownInfo() {
  ...
  const e = displayAllTimeStatsArrayOfObjects.filter(
    (e) => "TRUE" === e.ALLOWEDONSITE
  );
...
function t(t) {
  var o = Array.isArray(t) ? e(t) : void 0;
  if (
    (o ||
      (o =
...
function u() {
  var e = l[o.scrollLeft / o.clientWidth];
  e && s(e);
}
function getHomepageTabNextFixturesInfo(e) {
  console.log(
    "%c>> getHomepageTabNextFixturesInfo.",
    "background-color: orange; color:black; padding: 0.5em 0em; font-weight: bold;"
  ),
    (displayNextFixturesArrayOfObjects = e.data),
    showHomepageTabNextFixturesInfo(displayNextFixturesArrayOfObjects);
}
function showHomepageTabNextFixturesInfo(e) {
  console.log(
  ...
  for (let e = 0; e < o.length; e++) {
    var n = t[e];
    (document.getElementById(o[e] + "-Opposition").innerHTML = n.NEXTOPPO),
      (document.getElementById(o[e] + "-Location").innerHTML = n.LOCATION),
      (document.getElementById(o[e] + "-Competition").innerHTML =
        n.COMPETITION),
      (document.getElementById(o[e] + "-LastResult").innerHTML = n.LASTRESULT);
  }
  incrementComponentReadyCount("Homepage Next Fixtures");
}
function getHomepageTabCaptainsAndAwardsInfo(e) {
  console.log(
    "%c>> getHomepageTabCaptainsAndAwardsInfo.",
    "background-color: orange; color:black; padding: 0.5em 0em; font-weight: bold;"
  ),
    (displayCaptainsAndAwardsArrayOfObjects = e.data),
    console.log("getHomepageTabCaptainsAndAwardsInfo"),
    console.log(displayCaptainsAndAwardsArrayOfObjects),
    showHomepageTabCaptainsAndAwardsInfo(
      displayCaptainsAndAwardsArrayOfObjects
    );
}
function showHomepageTabCaptainsAndAwardsInfo(e) {
  console.log(
  ...
  for (let e = 0; e < o; e++) {
    let o = t[e]["HTML ID"],
      n = t[e][i];
    document.getElementById("homepage-" + o).innerHTML = n;
  }
...
function createWeatherWidgetHTML(e, t, o) {
  let n = document.getElementById("weather-widget-container");
  n.innerHTML = "";
  let a = document.createElement("a");
  a.setAttribute("id", "weather-widget"),
    a.setAttribute("class", "weatherwidget-io"),
    a.setAttribute("SameSite", "None"),
    a.setAttribute("href", "https://forecast7.com/en/51d23n0d33/dorking/"),
    a.setAttribute("data-label_1", "PIXHAM LANE, DORKING"),
    a.setAttribute("data-label_2", "Weather"),
    a.setAttribute("data-icons", "Climacons Animated"),
    a.setAttribute("data-theme", "original"),
    a.setAttribute("data-basecolor", "rgba(0, 0, 0, 0.05)"),
    a.setAttribute("data-accent", "rgba(0, 0, 0, 0.05)"),
    a.setAttribute("data-highcolor", e),
    a.setAttribute("data-lowcolor", t),
    a.setAttribute("data-suncolor", "#F9ED32"),
    a.setAttribute("data-cloudfill", o),
    a.setAttribute("data-raincolor", "#00ffff"),
    (a.innerHTML = "PIXHAM LANE Weather"),
    n.appendChild(a);
  let s = document.createElement("script");
  s.setAttribute("id", "weatherwidget-io-js"),
    s.setAttribute("src", "https://weatherwidget.io/js/widget.min.js"),
    a.appendChild(s);
}
function getTotalClubStatsInfo(e) {
  console.log(
    "%c>> getTotalClubStatsInfo.",
    "background-color: pink; color:black; padding: 0.5em 0em; font-weight: bold;"
  ),
    (displayTotalClubStatsArrayOfObjects = e.data),
    showTotalClubStatsInfo(displayTotalClubStatsArrayOfObjects);
}
function showTotalClubStatsInfo(e) {
  console.log(
  ...
  const t = e;
  var o = t.length,
    n = document.getElementById("club-stats-season-selection-dropdown"),
    a = n.options[n.selectedIndex].text,
    s = document.getElementById("club-stats-team-selection-dropdown"),
    i = s.options[s.selectedIndex].text,
    r = a + " - " + i,
    l = 0;
  for (let e = 0; e < o; e++) t[e].ID === r && (l = e);
  let c = t[l];
  "Whole Club" === i
    ? ((document.getElementById("club-stats-main-header-text").innerHTML =
        "Club Stats"),
      (document.getElementById("club-stats-tab-text").innerHTML = "Club Stats"),
      displayInformation(
        "club-stats-information-bar",
        "Select a filter to begin reviewing further detailed club stats"
      ))
    : ((document.getElementById("club-stats-main-header-text").innerHTML =
        "Team Stats"),
      (document.getElementById("club-stats-tab-text").innerHTML = "Team Stats"),
      displayInformation(
        "club-stats-information-bar",
  ...
  for (let e = 0; e < d.length; e++)
    "" == c[d[e]]
      ? ((document.getElementById("club-team-stats-" + d[e]).innerHTML = "n/a"),
        document
          .getElementById("club-team-stats-" + d[e])
          .classList.add("hidden"),
        document
          .getElementById("club-team-stats-header-" + d[e])
          .classList.add("hidden"))
      : ((document.getElementById("club-team-stats-" + d[e]).innerHTML =
          c[d[e]]),
        document
          .getElementById("club-team-stats-" + d[e])
...
function getTeamSeasonResultsInfo(e) {}
function showTeamSeasonResultsInfo(e) {}
function updateClubStatsInfo() {
  console.log(
    ...
    rotateLogo("dorkinians-header-logo"),
    showTotalClubStatsInfo(displayTotalClubStatsArrayOfObjects),
    showTeamSeasonResultsInfo(displayTeamSeasonResultsArrayOfObjects),
    stopRotateLogo("dorkinians-header-logo");
}
function prefillPlayerStatsTab() {
  ...
  const e = Object.keys(statObject);
  console.groupCollapsed("PrefillPlayerStatsTab Info Logs");
  const t = ["this-season", "all-time"];
  for (let n = 0; n < t.length; n++)
    for (let a = 0; a < e.length; a++)
      try {
        document.getElementById(
          "player-stats-" + t[n] + "-stat-text-" + e[a]
        ).innerHTML = statObject[e[a]].displayText;
        let s = document.getElementById(
          "player-stats-" + t[n] + "-" + e[a] + "-container"
        );
        const i = document.createElement("span");
        i.className = "stats-tooltip-text";
        var o = document.createTextNode(statObject[e[a]].description);
        i.appendChild(o), s.appendChild(i), s.classList.add("stats-tooltip");
      } catch (e) {}
  console.groupEnd(),
    incrementComponentReadyCount("Player Stats - This Season Stats");
}
function getPlayerStatsThisSeasonTabInfo(e) {
  console.log(
    "%c>> getPlayerStatsThisSeasonTabInfo.",
    "background-color: blue; color:white; padding: 0.5em 0em; font-weight: bold;"
  ),
    (displayThisSeasonStatsArrayOfObjects = e.data),
    showPlayerStatsThisSeasonTabInfo(displayThisSeasonStatsArrayOfObjects);
}
function getPlayerStatsAllTimeTabInfo(e) {
  console.log(
    "%c>> getPlayerStatsAllTimeTabInfo.",
    "background-color: blue; color:white; padding: 0.5em 0em; font-weight: bold;"
  ),
    (displayAllTimeStatsArrayOfObjects = e.data),
    showPlayerStatsAllTimeTabInfo(displayAllTimeStatsArrayOfObjects),
    getPlayerDropdownInfo();
}
function showPlayerStatsThisSeasonTabInfo(e) {
  console.log(
  ...
  const a = filterArrayOfObjects(t, "NAME", n);
  (o = a.length),
    o > 1 && alert("More than one record returned for player selected!");
  const s = document.getElementById(
      "player-stats-this-season-stats-category-selection"
    ),
    i = s.options[s.selectedIndex].value,
    r = Object.keys(statObject);
  console.groupCollapsed("ShowPlayerStatsThisSeasonTabInfo Info Logs");
  for (let e = 0; e < r.length; e++)
    try {
      let t = document.getElementById("player-stats-this-season-" + r[e]),
        o = statObject[r[e]].statFormat;
      if ("Integer" == o) var l = Number(a[0][r[e]]).toLocaleString("en-UK");
      else if ("Decimal2" == o) l = Number(a[0][r[e]]).toFixed(2);
      else if ("Decimal1" == o) l = Number(a[0][r[e]]).toFixed(1);
      else l = a[0][r[e]];
      t.innerHTML = l;
      let n = document.getElementById(
        "player-stats-this-season-" + r[e] + "-container"
      );
      "All" == i
        ? n.classList.remove("hidden")
        : statObject[r[e]].statCategory == i
        ? n.classList.remove("hidden")
        : n.classList.add("hidden");
    } catch (t) {
      console.log("Stat = " + r[e] + " not found on sheet so skipping.");
    }
  console.groupEnd(),
    incrementComponentReadyCount("Player Stats - This Season Stats");
}
function showPlayerStatsAllTimeTabInfo(e) {
  console.log(
  ...
  const s = document.getElementById(
    ...
    i = s.options[s.selectedIndex].value,
    r = Object.keys(statObject);
  console.groupCollapsed("ShowPlayerStatsAllTimeTabInfo Info Logs");
  for (let e = 0; e < r.length; e++)
    try {
      var l = document.getElementById("player-stats-all-time-" + r[e]),
        c = statObject[r[e]].statFormat;
      if ("Integer" == c) var d = Number(a[0][r[e]]).toLocaleString("en-UK");
      else if ("Decimal2" == c) d = Number(a[0][r[e]]).toFixed(2);
      else if ("Decimal1" == c) d = Number(a[0][r[e]]).toFixed(1);
      else d = a[0][r[e]];
      (l.innerHTML = d),
        "All" == i
...
function getMatchDetailsInfo(e) {
  console.log(
    "%c>> getMatchDetailsInfo.",
    "background-color: lightblue; color:black; padding: 0.5em 0em; font-weight: bold;"
  ),
    (displayMatchDetailsArrayOfObjects = e.data),
    incrementComponentReadyCount("Match Details information fetched"),
    Papa.parse(displayTOTWSheetCSV, {
      download: !0,
      header: !0,
      fastmode: !0,
      complete: getTeamOfTheWeekPlayersInfo,
    });
}
function getTeamOfTheWeekPlayersInfo(e) {
  console.log(
    "%c>> getTeamOfTheWeekPlayersInfo.",
    "background-color: lightblue; color:black; padding: 0.5em 0em; font-weight: bold;"
  );
  for (let e = 1; e <= 11; e++)
    document.getElementById("totw-player-pos-" + e).onclick =
      showTOTWPlayerInfo;
  (displayTOTWArrayOfObjects = e.data), updateTeamOfTheWeekWeekNumberInfo();
}
function updateTeamOfTheWeekWeekNumberInfo() {
  console.log(
    ...
    rotateLogo("dorkinians-header-logo");
  let e = document.getElementById("TOTW-season-selection-dropdown").value,
    t = document.getElementById("TOTW-week-selection-dropdown");
  t.options.length = 0;
  const o = displayTOTWArrayOfObjects.filter((t) => t.SEASON === e);
  let n = o.length;
  for (let e = 0; e < n; e++) {
    let n = document.createElement("option");
    (n.text =
      "Week " + o[e]["WEEK ADJUSTED"] + " (" + o[e]["DATE LOOKUP"] + ")"),
      (n.value = o[e].WEEK),
      t.add(n);
  }
...
function showTeamOfTheWeekPlayersInfo(e) {
  console.log(
  ...
  const t = e;
  var o = t.length,
    n = document.getElementById("TOTW-season-selection-dropdown"),
    a = n.options[n.selectedIndex].text,
    s = document.getElementById("TOTW-week-selection-dropdown"),
    i = s.options[s.selectedIndex].value,
    r = a + "-" + i,
    l = 0;
  for (let e = 0; e < o; e++) t[e]["SEASON WEEK NUM REF"] === r && (l = e);
  TOTWStatObject = t[l];
  let c = TOTWStatObject["BEST FORMATION"];
  document.getElementById("totw-total-points").innerHTML =
    TOTWStatObject["TOTW SCORE"];
  let d = TOTWStatObject["SEASON WEEK NUM REF"];
  const m = displayMatchDetailsArrayOfObjects.filter(
    (e) => e.SEASONWEEKNUMREF === d
  );
  let u = m.length;
  document.getElementById("totw-week-number-players").innerHTML =
    "Number Players Played: " + u;
  var p,
    y = 0;
  for (let e = 1; e <= 11; e++) {
    var g = TOTWStatObject["POS " + e + " PLAYER"];
    if (g.length > 12) {
      let e = g.indexOf(" ") + 1,
        t = g.substring(0, e),
        o = g.substring(e, e + 1);
    ...
    (document.getElementById("totw-player-pos-" + e + "-name").innerHTML = g),
      (document.getElementById("totw-player-pos-" + e + "-points").innerHTML =
        TOTWStatObject["POS " + e + " POINTS"]),
      parseInt(TOTWStatObject["POS " + e + " POINTS"]) > y &&
        ((y = parseInt(TOTWStatObject["POS " + e + " POINTS"])), (p = e));
    let t = document.getElementById("totw-player-pos-" + e),
      o = parseInt(formationCoordinateObject[c]["Pos" + e].x),
      n = parseInt(formationCoordinateObject[c]["Pos" + e].y);
    (t.style.left = o + "%"), (t.style.top = n + "%");
  }
  (document.getElementById("totw-player-pos-star-man-name").innerHTML =
    TOTWStatObject["POS " + p + " PLAYER"]),
    (document.getElementById("totw-player-pos-star-man-points").innerHTML =
      TOTWStatObject["POS " + p + " POINTS"]),
...
function closeTOTWPlayerInfo() {
  console.log(
    ...
    (document.getElementById("totw-player-info-box").style.display = "none");
}
function showComparisonStatData() {
  ...
  const e = Object.keys(statObject);
  console.groupCollapsed("showComparisonStatData Info Logs");
  for (let o = 0; o < e.length; o++)
    try {
      console.log("comparison-" + e[o] + "-short-text"),
        (document.getElementById(
          "comparison-" + e[o] + "-short-text"
        ).innerHTML = statObject[e[o]].shortText);
      let n = document.getElementById("comparison-" + e[o] + "-container");
      const a = document.createElement("span");
      a.className = "stats-tooltip-text";
      var t = document.createTextNode(statObject[e[o]].description);
      a.appendChild(t),
        n.appendChild(a),
        n.classList.add("stats-tooltip"),
        console.log("Stat = " + e[o] + " found on sheet so populating.");
    } catch (t) {
      console.warn("Stat = " + e[o] + " not found on sheet so skipping.");
    }
  console.groupEnd();
}
function updateComparisonStatData() {
  ...
  const o = Object.keys(statObject);
  if (
    (console.groupCollapsed("UpdateComparisonStatData Info Logs"),
    "Select Player 1" === e && "Select Player 2" === t)
  ) {
    ...
    for (let n = 0; n < o.length; n++)
      try {
        loadInComparisonStatNumbers(o[n], e, t, !1),
          console.log("Stat = " + o[n] + " found on sheet so populating.");
      } catch (e) {
        console.warn("Stat = " + o[n] + " not found on sheet so skipping.");
      }
  } else if ("Select Player 1" === e) {
    ...
    for (let n = 0; n < o.length; n++)
      try {
        loadInComparisonStatNumbers(o[n], e, t, !0),
          console.log("Stat = " + o[n] + " found on sheet so populating.");
      } catch (e) {
        console.warn("Stat = " + o[n] + " not found on sheet so skipping.");
      }
...
function loadInComparisonStatNumbers(e, t, o, n) {
  var a = displayAllTimeStatsArrayOfObjects.length;
  let s = statObject[e].statHigherBetterBoolean,
    i = ["", "", ""];
  i =
    "Select Player 1" === t
      ? ["", "", o]
      ...
      : ["", t, o];
  let r = ["", "", ""];
  const l = document.getElementById("comparison-category-selection"),
    c = l.options[l.selectedIndex].value;
  console.log("Selected stat category (statCategoryValue) = " + c);
  for (let t = 1; t < i.length; t++)
    if ("" == i[t]) {
      var d = document.getElementById(
        "comparison-" + e + "-player-" + t + "-value"
      );
      d.innerHTML = "";
    } else {
      const o = filterArrayOfObjects(
        displayAllTimeStatsArrayOfObjects,
        "NAME",
        i[t]
      );
      (a = o.length),
        a > 1 && alert("More than one record returned for player selected!");
      d = document.getElementById(
        "comparison-" + e + "-player-" + t + "-value"
      );
      var m = o[0][e],
        u = formatValue(o[0][e], statObject[e].statFormat);
      console.warn(u),
        (d.innerHTML = u),
        (r[t] = parseFloat(m)),
        !0 === n &&
          setTimeout(function () {
            var o = document.getElementById(
              "comparison-" + e + "-player-" + t + "-bar"
            );
            o.style.animation = "progress-animation 3s forwards";
          }, 1);
    }
  !0 === n &&
    (r[1] === r[2]
      ? ((BarElement = document
          .getElementById("comparison-" + e + "-player-1-bar")
          .classList.remove("yellow")),
        (BarElement = document
          .getElementById("comparison-" + e + "-player-2-bar")
          .classList.remove("yellow")))
      : !0 === s
      ? r[1] > r[2]
        ? ((BarElement = document
        ...
        ? ((BarElement = document
          ...
          (BarElement = document
            .getElementById("comparison-" + e + "-player-1-bar")
            .classList.remove("yellow")))
        : console.warn("Error in logic for stat " + e + ".")
      : r[1] < r[2]
      ? ((BarElement = document
          .getElementById("comparison-" + e + "-player-1-bar")
          .classList.add("yellow")),
  ...
  r[1] + r[2] === 0
    ? ((BarElement = document.getElementById(
        "comparison-" + e + "-player-1-bar-container"
      ).style.width =
        "0%"),
      (BarElement = document.getElementById(
        "comparison-" + e + "-player-2-bar-container"
      ).style.width =
        "0%"))
    : ((y = Math.floor((r[1] / p) * 100)),
      (BarElement = document.getElementById(
        "comparison-" + e + "-player-1-bar-container"
      ).style.width =
        y + "%"),
      (y = Math.floor((r[2] / p) * 100)),
      (BarElement = document.getElementById(
        "comparison-" + e + "-player-2-bar-container"
      ).style.width =
        y + "%"));
  let g = document.getElementById("comparison-" + e + "-container");
  console.log("containerElement = comparison-" + e + "-container"),
    "All" == c
      ? g.classList.remove("hidden")
      : statObject[e].statCategory == c
      ? g.classList.remove("hidden")
...
function resetStatsBars() {
  ...
  const e = Object.keys(statObject);
  console.groupCollapsed("ResetStatsBars Info Logs");
  for (let o = 0; o < e.length; o++) {
    console.log("Stat being worked on: " + e[o]);
    try {
      var t = document.getElementById("comparison-" + e[o] + "-player-1-bar");
      (t.style.animation = ""),
        t.classList.remove("yellow"),
        (t = document.getElementById(
          "comparison-" + e[o] + "-player-1-bar-container"
        )),
        (t.style.width = "0"),
        (t = document.getElementById("comparison-" + e[o] + "-player-2-bar")),
        (t.style.animation = ""),
        t.classList.remove("yellow"),
        (t = document.getElementById(
          "comparison-" + e[o] + "-player-2-bar-container"
        )),
        (t.style.width = "0");
    } catch (t) {
      console.info("Stat = " + e[o] + " not found on sheet so skipping.");
    }
  }
  console.groupEnd();
}
function updateTablesResultsandFixturesTab() {
  ...
  let o = ["1s", "2s", "3s", "4s", "5s", "6s", "7s", "8s"];
  for (let e = 0; e < o.length; e++) {
    var n = document.getElementById("dorkinians" + o[e] + "Table"),
      a = document.getElementById("dorkinians" + o[e] + "ResultsAndFixtures");
    o[e] === t
      ? (n.classList.remove("hidden"), a.classList.remove("hidden"))
      : "WholeClub" === t
      ? (n.classList.remove("hidden"), a.classList.remove("hidden"))
      : (n.classList.add("hidden"), a.classList.add("hidden"));
  }
  stopRotateLogo("dorkinians-header-logo");
}
function openPopUpBox(e, t) {
  (document.getElementById("pop-up-box").style.display = "inline"),
    (document.getElementById("background-overlay-pop-up-box").style.display =
      "inline"),
    (document.getElementById(
      "background-overlay-pop-up-box"
    ).style.zIndex = 29),
    (document.getElementById("pop-up-box-header-text").innerHTML = e),
    (document.getElementById("pop-up-box-message-text").innerHTML = t);
}
...
function createFullTable(e, t, o, n) {
  let a = document.querySelector(t);
  if ("array" == n) var s = e[0];
  else if ("object" == n) s = Object.keys(e[0]);
  else
    alert(
      "Error - No dataForm passed to 'createFullTable' in jMainFunctions.js."
    );
  generateTableHead(a, s, e, o), generateTable(a, e, o);
}
function generateTableHead(e, t, o, n) {
  let a = e.createTHead(),
    s = a.insertRow();
  var i = 0;
  for (let e of t) {
    ...
    if (1 == n) {
      ...
      if ((t.appendChild(r), 0 == i));
      else {
        t.classList.add("tooltip");
        var l = document.createElement("p");
        (l.innerHTML = o[0][e]),
          l.classList.add("tooltiptext"),
          l.classList.add("wordwrap"),
          t.appendChild(l);
      }
    } else {
    ...
    0 == i &&
      (t.classList.add("sticky-col"),
      t.classList.add("first-col"),
      t.classList.add("first-cell")),
      t.classList.add("textleft"),
      s.appendChild(t),
      (i += 1);
  }
}
function generateTable(e, t, o) {
  var n,
    a,
    s = 1;
  let i = e.createTBody();
  for (let e of t) {
    ...
    if (((n = 0), s <= 1));
      ...
      for (key in e) {
        let o = t.insertCell(),
          s = document.createTextNode(e[key]);
        o.appendChild(s),
          0 == n &&
            (o.classList.add("sticky-col"), o.classList.add("first-col")),
          (a = parseInt(e[key])),
          1 == isNaN(a)
            ? ((dataType = "string"), o.classList.add("textleft"))
            : ((dataType = typeof a), o.classList.add("textcenter")),
          (n += 1);
      }
    s += 1;
  }
}
function filterArrayOfObjects(e, t, o) {
  const n = e.filter((e) => e[t].includes(o));
  return n;
}
function multiFilterArrayOfObjects(e, t, o, n, a, s, i, r, l, c) {
  var d = e;
  if ((console.log(e), !0 === t)) {
    var m = [d.shift()],
      u = d.slice(1);
    d = u;
  }
  if (
    ("Season" === n ||
      "All Seasons" === n ||
      (d = d.filter((e) => e[o].includes(n))),
    "Player" === s || (d = d.filter((e) => e[a].includes(s))),
    "Team" === r || (d = d.filter((e) => e[i].includes(r))),
    "Location" === c || (d = d.filter((e) => e[l].includes(c))),
    !0 === t)
  )
    d = m.concat(d);
  return d;
...
function formatValue(e, t) {
  if ("Integer" == t) var o = Number(e).toLocaleString("en-UK");
  else if ("Decimal2" == t) o = Number(e).toFixed(2);
  else if ("Decimal1" == t) o = Number(e).toFixed(1);
  else o = e;
  return o;
}
...
function nextDay(e, t) {
  return e.setDate(e.getDate() + ((t + (7 - e.getDay())) % 7)), e;
}
function rotateLogo(e) {
  var t = document.getElementById(e);
  t.classList.add("rotate"),
    t.classList.add("linear"),
    t.classList.add("infinite");
}
function stopRotateLogo(e) {
  var t = document.getElementById(e);
  t.classList.remove("rotate"),
    t.classList.remove("linear"),
    t.classList.remove("infinite");
}
function displayInformation(e, t) {
  var o = document.getElementById(e);
  o.innerHTML = t;
}
function populateDropdownList(e, t, o, n, a) {
  for (let s = 0; s < t.length; s++) {
    let i = document.createElement("div");
    i.classList.add("selection-dropdown-option"),
      i.classList.add("textleft"),
      (i.onclick = function () {
        (document.getElementById(n).value = t[s]),
          (document.getElementById(n).innerHTML =
            t[s] +
            "<img src='/images/Down Arrow Icon.webp' alt='Down Arrow Icon' class='selection-dropdown-arrow-icon' height='25px' width='25px'>"),
          closeDropdownList(o, e),
          "player-stats" == e
            ? showPlayerStatsTabUpdatedInfo()
            : "comparison" == e
            ? updateComparisonStatData()
            : alert(o + " dropdown called from an unknown tab location?");
      });
    let r = document.createTextNode(t[s]);
    i.appendChild(r);
    let l = document.getElementById(a);
    l.appendChild(i);
  }
}
function showDropdownList(e, t) {
  (document.getElementById(e + "-contents").style.display = "block"),
    (document.getElementById(e + "-contents").style.zIndex = 10),
    (document.getElementById(
      "background-overlay-selection-dropdown-" + t
    ...
    (document.getElementById(
      ...
      closeDropdownList(e, t);
    });
}
function filterDropdownList(e, t) {
  console.log("filterDropdownList clicked for dropdownID: " + e);
  let o = document.getElementById(t),
    n = o.value.toUpperCase(),
    a = document.getElementById(e),
    s = a.getElementsByClassName("selection-dropdown-option");
  for (i = 0; i < s.length; i++)
    (txtValue = s[i].textContent || s[i].innerText),
      txtValue.toUpperCase().indexOf(n) > -1
        ? (s[i].style.display = "")
        : (s[i].style.display = "none");
}
function closeDropdownList(e, t) {
  (document.getElementById(e + "-contents").style.display = "none"),
    (document.getElementById(
      "background-overlay-selection-dropdown-" + t
    ).style.display = "none");
}
...
var phrasesArray = [
  ...
  "Ignoring Rich's match fee and membership messages...",
];
const statObject = {
    APP: {
      statName: "Appearances",
      displayText: "Appearances:",
      shortText: "Apps",
      statFormat: "Integer",
      description: "The number of appearances made by the player.",
      statHigherBetterBoolean: !0,
    ...
    MOM: {
      ...
      displayText: "Man of the Matches:",
      shortText: "MoMs",
      statFormat: "Integer",
      description:
    ...
    Y: {
      ...
      displayText: "Yellow cards received:",
      shortText: "Yel",
      statFormat: "Integer",
      description: "The number of yellow cards received by the player.",
      statHigherBetterBooleanArray: !1,
      numberDecimalPlaces: 0,
      statCategory: "Performance Stat",
    },
    R: {
      statName: "Red Cards",
      displayText: "Red cards received:",
      shortText: "Red",
      statFormat: "Integer",
      description: "The number of red cards received by the player.",
      statHigherBetterBoolean: !1,
      numberDecimalPlaces: 0,
      statCategory: "Performance Stat",
    },
    OG: {
      statName: "Own Goals",
      displayText: "Own goals scored:",
      shortText: "OGs",
      statFormat: "Integer",
    ...
    CLS: {
      ...
      displayText: "Clean sheets achieved:",
      shortText: "CLS",
      statFormat: "Integer",
    ...
    PCO: {
      ...
      displayText: "Penalties conceded:",
      shortText: "Pens Con",
      statFormat: "Integer",
    ...
    FTP: {
      ...
      displayText: "Fantasy points achieved:",
      shortText: "FTP",
      statFormat: "Integer",
    ...
    CperAPP: {
      ...
      displayText: "Goals conceded per app:",
      shortText: "CperApp",
      statFormat: "Decimal2",
      description:
    ...
    MperG: {
      ...
      displayText: "Minutes per goal scored:",
      shortText: "MperG",
      statFormat: "Integer",
      description:
    ...
    MperCLS: {
      ...
      displayText: "Minutes per clean sheet:",
      shortText: "MperCLS",
      statFormat: "Integer",
      description:
    ...
    FTPperAPP: {
      ...
      displayText: "Fantasy points per app:",
      shortText: "FTPperApp",
      statFormat: "Decimal2",
      description:
    ...
    DIST: {
      ...
      displayText: "Distance travelled:",
      shortText: "Dist",
      statFormat: "Decimal1",
      description:
    ...
    MostPlayedForTeam: {
      ...
      displayText: "Most played for team:",
      shortText: "Most Play",
      statFormat: "String",
    ...
    NumberTeamsPlayedFor: {
      ...
      displayText: "Number teams played for:",
      shortText: "# Teams",
      statFormat: "String",
      description:
    ...
    NumberSeasonsPlayedFor: {
      ...
      displayText: "Number seasons played for:",
      shortText: "# Seasons",
      statFormat: "String",
      description:
    ...
    MostScoredForTeam: {
      ...
      displayText: "Most scored for team:",
      shortText: "Most G",
      statFormat: "String",
      description:
        "The Dorkinians team that the player has scored the most for.",
      statHigherBetterBoolean: !1,
      numberDecimalPlaces: 0,
      statCategory: "Appearance Stat",
    },
  },
  siteDetailsSheetURLCSV =
...
var displaySiteDetailsArrayOfObjects = "";
...
var displayNextFixturesArrayOfObjects = "";
...
var displayCaptainsAndAwardsArrayOfObjects = "";
...
var displayTotalClubStatsArrayOfObjects = "";
...
var displayTeamSeasonResultsArrayOfObjects = "";
...
var displayThisSeasonStatsArrayOfObjects = "";
...
var displayMatchDetailsArrayOfObjects = "",
  TOTWStatObject = "";
...
class sideMenu extends HTMLElement {
  ...
  connectedCallback() {
    ...
    t.setAttribute("rel", "stylesheet"),
      t.setAttribute("href", "/DorkiniansMain.min.css"),
      e.appendChild(t),
      e.appendChild(sideMenuTemplate.content);
  }
}
customElements.define("side-menu-component", sideMenu);
var sideMenuWidth = "80%",
  fontSizeMin = 10,
  fontSizeMax = 22,
  pageHeightMin = 0,
  pageHeightMax = 100;
!(function () {
  ...
  function o(e) {
    return (e = e.trim().match(/^(-?[0-9]*\.?[0-9]*)(px|%)$/))
      ? { value: e[1], unit: e[2] }
      : null;
  }
  function n(e) {
  ...
  function a(e) {
    var t = r.get(e).animations;
    if (0 !== t.length) {
      e = e.currentTime;
      for (var o = 0; o < t.length; o++)
        null == e
          ? "paused" === t[o].playState && t[o].cancel()
          : (t[o].currentTime = e);
    }
  }
  function s(e) {
    return 1 / 0 === e.iterationCount
      ? 1 / 0
      : Math.max(
          (e.startDelay || 0) +
            (e.duration || 0) * (e.iterationCount || 1) +
            (e.endDelay || 0),
          0
        );
  }
  function i(e, t, n, a, s) {
    return s
      ? s(t, n, a, "0%" === e ? "start" : "end")
      : ("block" === n
          ? (n = "vertical")
          : "inline" === n && (n = "horizontal"),
        (t =
          "vertical" === n
  ...
  var r = new WeakMap(),
    ...
    c = (function () {
      function e(e) {
        r.set(this, {
          ...
          (this.scrollSource =
            (e && e.scrollSource) || document.scrollingElement),
          (this.orientation = (e && e.orientation) || "block"),
          (this.startScrollOffset = (e && e.startScrollOffset) || "auto"),
          (this.endScrollOffset = (e && e.endScrollOffset) || "auto"),
          (this.timeRange = (e && e.timeRange) || "auto"),
          (this.fill = (e && e.fill) || "none");
      }
      return (
        t(e, [
          {
            ...
            set: function (e) {
              var t = this;
              this.scrollSource &&
                n(this.scrollSource).removeEventListener("scroll", function () {
                  return a(t);
                }),
                e instanceof Element || (e = document.scrollingElement),
                (r.get(this).scrollSource = e),
                n(e).addEventListener("scroll", function () {
                  return a(t);
                }),
                a(this);
            },
            get: function () {
              return r.get(this).scrollSource;
            },
          },
          {
            key: "orientation",
            set: function (e) {
              -1 === ["block", "inline", "horizontal", "vertical"].indexOf(e) &&
                (e = "block"),
                (r.get(this).orientation = e),
                a(this);
            },
            get: function () {
              return r.get(this).orientation;
            },
          },
          {
            ...
            set: function (e) {
              var t = r.get(this);
              t.startScrollOffsetFunction = null;
              for (var o = 0; o < l.length; o++) {
                var n = l[o].parse(e);
                if (void 0 !== n) {
                  (e = n), (t.startScrollOffsetFunction = l[o].evaluate);
                  break;
                }
              }
              (t.startScrollOffset = e), a(this);
            },
            get: function () {
              return r.get(this).startScrollOffset;
            },
          },
          {
            key: "endScrollOffset",
            set: function (e) {
              r.get(this).endScrollOffsetFunction = null;
              for (var t = 0; t < l.length; t++) {
                var o = l[t].parse(e);
                if (void 0 !== o) {
                  (e = o),
                    (r.get(this).endScrollOffsetFunction = l[t].evaluate);
                  break;
                }
              }
              (r.get(this).endScrollOffset = e), a(this);
            },
            get: function () {
              return r.get(this).endScrollOffset;
            },
          },
          {
            key: "timeRange",
            set: function (e) {
              (r.get(this).timeRange = e), a(this);
            },
            get: function () {
              return r.get(this).timeRange;
            },
          },
          {
            key: "currentTime",
            get: function () {
              ...
              var e,
                ...
                o = i(
                  ...
                  r.get(this).startScrollOffsetFunction
                ),
                n = i(
                  "100%",
                  this.scrollSource,
                  ...
                  r.get(this).endScrollOffsetFunction
                ),
                a = this.timeRange;
              if ("auto" === a) {
                a = 0;
                for (
                  var l = r.get(this).animationOptions, c = 0;
                  c < l.length;
                  c++
                )
                  a = Math.max(a, s(l[c]));
              ...
              return (
                ...
                l < o
                  ...
                  ? n <
                      ((e = this.scrollSource),
                      "block" === (t = this.orientation)
                        ? (t = "vertical")
                        : "inline" === t && (t = "horizontal"),
                      "vertical" === t
        ...
        t(e, [
          {
            ...
            set: function (e) {
              if (!(e instanceof Element))
                throw (
                  ((d.get(this).target = null),
                  Error("Intersection target must be an element."))
                );
              d.get(this).target = e;
            },
            get: function () {
              return d.get(this).target;
            },
          },
          {
            key: "edge",
            set: function (e) {
              -1 != ["start", "end"].indexOf(e) && (d.get(this).edge = e);
            },
            get: function () {
              return d.get(this).edge;
            },
          },
          {
            key: "threshold",
            set: function (e) {
              ...
              d.get(this).threshold = e;
            },
            get: function () {
              return d.get(this).threshold;
            },
          },
          {
            key: "rootMargin",
            set: function (e) {
              if (1 > (e = e.split(/ +/)).length || 4 < e.length)
                throw TypeError(
                  "rootMargin must contain between 1 and 4 length components"
                );
              for (var t = [[], [], [], []], n = 0; n < e.length; n++) {
                var a = o(e[n]);
                if (!a) throw TypeError("Unrecognized rootMargin length");
                for (var s = m[e.length - 1][n], i = 0; i < s.length; i++)
                  t[s[i]] = [parseFloat(a.value), a.unit];
              }
              d.get(this).rootMargin = t;
            },
            get: function () {
              return d
                .get(this)
    ...
    p = window.Element.prototype.animate;
  if (
    (l.push({
      parse: function (e) {
        if (e.target) return new u(e);
      },
      evaluate: function (e, t, o) {
        ...
        for (
          ...
          i.push(
            "%" == (n = s[r])[1]
              ? (n[0] * (0 == r % 2 ? a.height : a.width)) / 100
              : n[0]
          );
        (s = a.left - i[3]),
          (n = a.right - a.left + i[3] + i[1]),
          (r = a.top - i[0]),
          (i = a.bottom - a.top + i[0] + i[2]),
          (a = d.get(o).clamp);
        var l = o.target.getBoundingClientRect(),
          c = o.threshold;
        return (
          "start" == o.edge && (c = 1 - c),
          "vertical" == t
            ? ((t = l.top + l.height * c - r + e.scrollTop),
              a
                ? "end" == o.edge
                  ? Math.max(0, t - i)
                  : Math.min(t, e.scrollHeight - i)
                : "end" == o.edge
                ? t - i
                : t)
            : ((t = l.left + l.width * c - s + e.scrollLeft),
              a
                ? "end" == o.edge
                  ? Math.max(0, t - n)
                  : Math.min(t, e.scrollWidth - n)
                : "end" == o.edge
                ? t - n
                : t)
        );
  ...
  if (
    !Reflect.defineProperty(Element.prototype, "animate", {
      value: function (e, t) {
        var o = t.timeline;
        if (!(o && o instanceof c)) return p.apply(this, [e, t]);
        delete t.timeline, (e = p.apply(this, [e, t])).pause();
        var n = r.get(o).animations,
          s = r.get(o).animationOptions;
        return n.push(e), s.push(t), a(o), e;
      },
    })
  )
    throw Error(
...
l.forEach(function (e) {
  ...
  n &&
    a.animate(
      {
        transform: t(l).map(function (e) {
          return "translateX(".concat(e.offsetLeft, "px)");
        }),
        width: t(l).map(function (e) {
          return "".concat(e.offsetWidth, "px");
        }),
      },
      { duration: 1e3, fill: "both", timeline: c }
    ),
  i.addEventListener("click", function (e) {
    "A" === e.target.nodeName && s(e.target);
  }),
...
let GKy = 1,
  ...
  FWDy = 71,
  PlayerWidth = 20,
  Centerx = 50 - PlayerWidth / 2,
  LeftOf2x = 30 - PlayerWidth / 2,
  RightOf2x = 70 - PlayerWidth / 2,
  LeftOf3x = 25 - PlayerWidth / 2,
  RightOf3x = 75 - PlayerWidth / 2,
  LeftOf4x = 15 - PlayerWidth / 2,
  LeftCenterOf4x = 35 - PlayerWidth / 2,
  RightCenterOf4x = 65 - PlayerWidth / 2,
  RightOf4x = 85 - PlayerWidth / 2,
  LeftOf5x = 10 - PlayerWidth / 2,
  LeftCenterOf5x = 30 - PlayerWidth / 2,
  RightCenterOf5x = 70 - PlayerWidth / 2,
  RightOf5x = 90 - PlayerWidth / 2;
const formationCoordinateObject = {
    "4-4-2": {
      Pos1: { Classification: "GK", x: Centerx, y: GKy },
      Pos2: { Classification: "DEF1", x: LeftOf4x, y: DEFy },
      Pos3: { Classification: "DEF2", x: LeftCenterOf4x, y: DEFy },
      Pos4: { Classification: "DEF3", x: RightCenterOf4x, y: DEFy },
      Pos5: { Classification: "DEF4", x: RightOf4x, y: DEFy },
      Pos6: { Classification: "MID1", x: LeftOf4x, y: MIDy },
      Pos7: { Classification: "MID2", x: LeftCenterOf4x, y: MIDy },
      Pos8: { Classification: "MID3", x: RightCenterOf4x, y: MIDy },
      Pos9: { Classification: "MID4", x: RightOf4x, y: MIDy },
      Pos10: { Classification: "FWD1", x: LeftOf2x, y: FWDy },
      Pos11: { Classification: "FWD2", x: RightOf2x, y: FWDy },
    },
    "4-3-3": {
      Pos1: { Classification: "GK", x: Centerx, y: GKy },
      Pos2: { Classification: "DEF1", x: LeftOf4x, y: DEFy },
      ...
      Pos4: { Classification: "DEF3", x: RightCenterOf4x, y: DEFy },
      Pos5: { Classification: "DEF4", x: RightOf4x, y: DEFy },
      Pos6: { Classification: "MID1", x: LeftOf3x, y: MIDy },
      Pos7: { Classification: "MID2", x: Centerx, y: MIDy },
      Pos8: { Classification: "MID3", x: RightOf3x, y: MIDy },
      Pos9: { Classification: "FWD1", x: LeftOf3x, y: FWDy },
      Pos10: { Classification: "FWD2", x: Centerx, y: FWDy },
      Pos11: { Classification: "FWD3", x: RightOf3x, y: FWDy },
    },
    "4-5-1": {
      Pos1: { Classification: "GK", x: Centerx, y: GKy },
      Pos2: { Classification: "DEF1", x: LeftOf4x, y: DEFy },
      ...
      Pos4: { Classification: "DEF3", x: RightCenterOf4x, y: DEFy },
      Pos5: { Classification: "DEF4", x: RightOf4x, y: DEFy },
      Pos6: { Classification: "MID1", x: LeftOf5x, y: MIDy },
      Pos7: { Classification: "MID2", x: LeftCenterOf5x, y: MIDy },
      Pos8: { Classification: "MID3", x: Centerx, y: MIDy },
      Pos9: { Classification: "MID4", x: RightCenterOf5x, y: MIDy },
      Pos10: { Classification: "MID5", x: RightOf5x, y: MIDy },
      Pos11: { Classification: "FWD1", x: Centerx, y: FWDy },
    },
    "3-5-2": {
      Pos1: { Classification: "GK", x: Centerx, y: GKy },
      Pos2: { Classification: "DEF1", x: LeftOf3x, y: DEFy },
      Pos3: { Classification: "DEF2", x: Centerx, y: DEFy },
      Pos4: { Classification: "DEF3", x: RightOf3x, y: DEFy },
      Pos5: { Classification: "MID1", x: LeftOf5x, y: MIDy },
      Pos6: { Classification: "MID2", x: LeftCenterOf5x, y: MIDy },
      Pos7: { Classification: "MID3", x: Centerx, y: MIDy },
      Pos8: { Classification: "MID4", x: RightCenterOf5x, y: MIDy },
      Pos9: { Classification: "MID5", x: RightOf5x, y: MIDy },
      Pos10: { Classification: "FWD1", x: LeftOf2x, y: FWDy },
      Pos11: { Classification: "FWD2", x: RightOf2x, y: FWDy },
    },
    "3-4-3": {
      ...
      Pos3: { Classification: "DEF2", x: Centerx, y: DEFy },
      Pos4: { Classification: "DEF3", x: RightOf3x, y: DEFy },
      Pos5: { Classification: "MID1", x: LeftOf4x, y: MIDy },
      Pos6: { Classification: "MID2", x: LeftCenterOf4x, y: MIDy },
      Pos7: { Classification: "MID3", x: RightCenterOf4x, y: MIDy },
      Pos8: { Classification: "MID4", x: RightOf4x, y: MIDy },
      Pos9: { Classification: "FWD1", x: LeftOf3x, y: FWDy },
      Pos10: { Classification: "FWD2", x: Centerx, y: FWDy },
      Pos11: { Classification: "FWD3", x: RightOf3x, y: FWDy },
    },
    "5-3-2": {
      Pos1: { Classification: "GK", x: Centerx, y: GKy },
      Pos2: { Classification: "DEF1", x: LeftOf5x, y: DEFy },
      Pos3: { Classification: "DEF2", x: LeftCenterOf5x, y: DEFy },
      Pos4: { Classification: "DEF3", x: Centerx, y: DEFy },
      Pos5: { Classification: "DEF4", x: RightCenterOf5x, y: DEFy },
      Pos6: { Classification: "DEF5", x: RightOf5x, y: DEFy },
      Pos7: { Classification: "MID1", x: LeftOf3x, y: MIDy },
      Pos8: { Classification: "MID2", x: Centerx, y: MIDy },
      Pos9: { Classification: "MID3", x: RightOf3x, y: MIDy },
      Pos10: { Classification: "FWD1", x: LeftOf2x, y: FWDy },
      Pos11: { Classification: "FWD2", x: RightOf2x, y: FWDy },
    },
    "5-4-1": {
      ...
      Pos5: { Classification: "DEF4", x: RightCenterOf5x, y: DEFy },
      Pos6: { Classification: "DEF5", x: RightOf5x, y: DEFy },
      Pos7: { Classification: "MID1", x: LeftOf4x, y: MIDy },
      Pos8: { Classification: "MID2", x: LeftCenterOf4x, y: MIDy },
      Pos9: { Classification: "MID3", x: RightCenterOf4x, y: MIDy },
      Pos10: { Classification: "MID4", x: RightOf4x, y: MIDy },
      Pos11: { Classification: "FWD1", x: Centerx, y: FWDy },
    },
  },
  showTOTWPlayerInfo = function () {
    console.log(
    ...
    let e = this.id,
      t = e.substring(16, 18),
      o = TOTWStatObject["POS " + t + " PLAYER"],
      n = TOTWStatObject["SEASON WEEK NUM REF"];
    displayMatchDetailsArrayOfObjects.length;
    const a = displayMatchDetailsArrayOfObjects.filter(
      (e) => e.SEASONWEEKNUMREF === n
    );
    a.length;
    const s = a.filter((e) => e.PLAYERNAME == o);
    s.length,
    ...
    let i = s[0].CLASS;
    console.log(
      "Clicked player number = " + e + ", name: " + o + ", position: " + i
    );
    let r = [
        "APP",
        "MOM",
    ...
    for (let e = 0; e < r.length; e++)
      if (
        (document
          .getElementById("totw-player-info-box-" + r[e] + "-row")
          .classList.remove("hidden"),
        "G" == r[e])
      ) {
        let e = 0;
        switch (
          ((e =
            "" == s[0].G && "" == s[0].PSC
              ...
              : "" == s[0].PSC
              ? parseInt(s[0].G)
              : parseInt(s[0].G) + parseInt(s[0].PSC)),
          0 == e &&
            document
        ...
        (document.getElementById("totw-player-info-box-G").innerHTML = e),
          (document.getElementById("totw-player-info-box-G-points").innerHTML =
            e * l);
      } else if (null == s[0][r[e]] || null == s[0][r[e]] || "" == s[0][r[e]])
        document
          .getElementById("totw-player-info-box-" + r[e] + "-row")
          .classList.add("hidden");
      else
        switch (
          ((document.getElementById("totw-player-info-box-" + r[e]).innerHTML =
            s[0][r[e]]),
          r[e])
        ) {
          case "APP":
          ...
          case "MOM":
            document.getElementById(
              "totw-player-info-box-MOM-points"
            ).innerHTML = 3 * s[0].MOM;
            break;
          case "A":
            ...
            if (0 == s[0].C || "0" == s[0].C) {
              ...
              switch (i) {
                ...
                case "DEF":
                  ...
                  ).innerHTML = Math.round(-0.5 * s[0].C);
                  break;
                case "MID":
                case "FWD":
                  document
          ...
          case "OG":
            document.getElementById(
              "totw-player-info-box-OG-points"
            ).innerHTML = -2 * s[0].OG;
            break;
          case "PM":
            document.getElementById(
              "totw-player-info-box-PM-points"
            ).innerHTML = -2 * s[0].PM;
            break;
          case "PCO":
            document.getElementById(
              "totw-player-info-box-PCO-points"
            ).innerHTML = 0 * s[0].PCO;
            break;
          case "PSV":
            document.getElementById(
              "totw-player-info-box-PSV-points"
            ).innerHTML = 5 * s[0].PSV;
            break;
          default:
            console.log(r[e] + " has defaulted.");
        }
    (document.getElementById("totw-player-info-box-FTP-points").innerHTML =
      ...
      (document.getElementById("totw-player-info-box").style.display =
        "inline"),
      (document.getElementById("totw-player-info-box").style.zIndex = 20),
      stopRotateLogo("dorkinians-header-logo");
  };
let roundOff = (e, t) => {
